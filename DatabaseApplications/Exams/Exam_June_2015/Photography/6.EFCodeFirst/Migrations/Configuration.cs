namespace _6.EFCodeFirst.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<_6.EFCodeFirst.ChatDbContext>
    {
        ...
        protected override void Seed(_6.EFCodeFirst.ChatDbContext context)
        {
            AddUsers(context);
