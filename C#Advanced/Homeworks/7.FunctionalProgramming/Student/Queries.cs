...
namespace Student
{
    class Queries
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Student("Ivan", "Georgiev", 24, "112a14", "1234", "vanko@",
                    new List<int>() {2, 3}, 1),
                new Student("Ilia", "Ivanov", 12, "456115", "456115", "@mail",
                    new List<int>() {3, 4, 4, 5}, 2),
                new Student("Anna", "Markov", 34, "789213", "789213", "ma@il",
                    new List<int>() {2, 2, 2, 2}, 3),
                new Student("Maria", "Stoyanova", 45, "123414", "123414", "mai@l",
                    new List<int>() {2, 4, 4}, 1),
                new Student("Mitko", "Mitkov", 5, "526114", "526114", "mitak@gmail.bg",
                    new List<int>() {6,6,6,6,6}, 2),
                new Student("Pehso", "Peshev", 123, "021237", "021237", "mail@a",
                    new List<int>() {2,3,3}, 3),
                new Student("Atanas", "Petrov", 2, "882214", "882214", "ma@il",
                ...
                new Student("Joro", "Ivanov", 54, "112315", "89123", "mai@@l",
                    new List<int>() {2, 3, 7, 5}, 1, "Spade"),
                new Student("Asen", "Georgiev", 64, "14g115", "0-123", "asen-georgiev51@abv.bg",
                    new List<int>() {2, 3, 2, 5}, 4, "Ace"),
                new Student("AsenI", "Georgiev", 64, "14g214", "0-123", "asaka@abv.bg",
